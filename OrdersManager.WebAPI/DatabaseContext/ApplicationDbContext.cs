    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Order>().HasData(
                new Order { OrderId = Guid.Parse("F4816224-70D6-4491-AC52-34F298ACE16F"), OrderNumber = "ORD_2024_1", CustomerName = "John Doe", OrderDate = DateTime.Now, TotalAmount = 66.5m },
                new Order { OrderId = Guid.Parse("735886C0-FAF3-49CA-9776-8A20B756F1CB"), OrderNumber = "ORD_2024_2", CustomerName = "Jane Smith", OrderDate = DateTime.Now, TotalAmount = 225.8m }
            );
